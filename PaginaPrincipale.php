...
<body id="Sfondo-Pagina">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="./AltrePagine/Accedi.php">Accedi oppure registrati</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./AltrePagine/Catalogo.php">Cataloghi: media e documenti</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./AltrePagine/ChiSiamo.php">Chi siamo</a>
                </li>
                <li class="nav-item">
    ...
    <div class="Sfondo-Presentazione">
        ...
        <div class="d-flex justify-content-center align-items-start gap-3">
            <button type="button" class="btn btn-warning">
                <a href="./AltrePagine/Catalogo.php" class="nav-link" id="Stile-Bottoni">Esplora l'archivio</a>
            </button>

            <button type="button" class="btn btn-light">
                <a href="./AltrePagine/ChiSiamo.php" class="nav-link" id="Stile-Bottoni">Cos'è BiblioNet?</a>
            </button>

            <button type="button" class="btn btn-primary">
                <a href="./AltrePagine/Media.php" class="nav-link" id="Stile-Bottoni">Audio e video</a>
            </button>
        </div>       
    ...
    <div class="Sfondo-Schede">
        ...
        <div class="card-body d-flex align-items-center">
            ...
            <div>
                <button type="button" class="btn btn-warning">
                <a href="./AltrePagine/Registrazione.php" class="nav-link" id="Stile-Bottoni">Registrati</a>
                </button>
            </div>
        </div>
        </div>
